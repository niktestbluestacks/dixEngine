...
using SimpleRenderSystemBindings =
    std::tuple<UniformBinding<SimpleUbo, 0, vk::ShaderStageFlagBits::eVertex>,
...
class SimpleRenderSystem
   ...
   public:
    ...
    SimpleRenderSystem(EngineDevice& engineDevice, vk::RenderPass renderPass,
